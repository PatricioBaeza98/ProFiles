...
<br>
    ...
    <?php
        $rut=$_SESSION['$varut'];
        $id_cursos=$_GET["id"];
        $hola123="SELECT cursos.id FROM usuario,cursos WHERE (usuario.rut=cursos.rut) and (usuario.rut='$rut') and (cursos.nombre_curso='MYSQL') ";
    ...
    <footer class="container">
        <div class="row border-top py-5">
            ...
            <h6 style="text-align: left;">Realizar prueba única: <a href="examen_mysql.php?id=<?php echo $id_cursos;?>">ENTRAR</a> </h6>
