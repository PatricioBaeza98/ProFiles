...
<h3>Bienvenido al curso de CSS BASICO</h3>
...
<br>
    ...
    <?php
        $rut=$_SESSION['$varut'];
        $id_cursos=$_GET["id"];
        $hola123="SELECT cursos.id FROM usuario,cursos WHERE (usuario.rut=cursos.rut) and (usuario.rut='$rut') and (cursos.nombre_curso='CSS BASICO') ";
    ...
    <footer class="container">
        <div class="row border-top py-5">
            ...
            <h6 style="text-align: left;">Realizar prueba única: <a href="examen_css.php?id=<?php echo $id_cursos;?>">ENTRAR</a> </h6>
                <a href="examen_mysql.php" class="btn btn-link">Subir en Pagina</a>
