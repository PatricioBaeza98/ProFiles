			...
			<div class="col-12 ">
				<div class="row">
					<div class="col-12 titulo">
						<h2 class="center">Publicaciones Desactivadas</h2>
					</div>
				</div>
				<div class="row">
					<?php
	        ...
	        $rut=$_SESSION['$varut'];
	         ...
	         while ($rowfoto=mysqli_fetch_assoc($rst)) {
	            $fotito=$rowfoto["ruta_imagen"];
			      ...
			      WHERE (rut_empresa='$rut') AND (estado='desactivada')";
	          mysqli_query($cnn,$sql1);
	          $rs=mysqli_query($cnn,$sql1);  
					...
					<div class="col-6">
						<form method="GET">
							<div class="card medium">
	                            ...
	                            <a href="editar_publicacion_ac.php?id_publicacion=<?php echo($row['id']);?>" class="btn btn-danger my-2 my-sm-0">Activar</a>
						              </p>
				            	</div>
	           				</div>
						</form>
