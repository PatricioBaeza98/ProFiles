...
<body>
  ...
  <form method="post">
    <div class="container shadow p-3 mb-5 bg-white rounded">
      ...
      <div class="row">
        <div class="col-12">
        <input type="submit" name="agendar" class="btn btn-primary" value="REAgendar">
        </div>
      </div>
      <br>
    </div>
   ...
   if(isset($_POST["agendar"])) 
    {
        ...
        $direccion=$_POST["txt_d"];
            ...
            $sql="UPDATE reunion SET fecha='$fecha',hora='$hora',ciudad='$ciudad',direccion='$direccion', motivo='CORREGIDO' WHERE id='$id_rrr'";
